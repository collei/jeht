<?php
namespace Jeht\Collections\Traits;
...
use Jeht\Collections\Enumerable;
use Jeht\Collections\HigherOrderCollectionProxy;
use Jeht\Collections\HigherOrderWhenProxy;
use JsonSerializable;
use Jeht\Debug\VarDumper;
use Traversable;
use UnexpectedValueException;
use UnitEnum;

/**
 * Adapted from Laravel's Illuminate\Support\Traits
 * @link https://laravel.com/api/8.x/Illuminate/Support/Traits/EnumeratesValues.html
 * @link https://github.com/laravel/framework/blob/8.x/src/Illuminate/Collections/Traits/EnumeratesValues.php
 *
