...
use Jeht\Ground\Mix;
use Jeht\Http\Exceptions\HttpException;
use Jeht\Http\Exceptions\HttpResponseException;
...
if (! function_exists('abort')) {
	 ...
	 *
	 * @param  \Jeht\Http\Response|\Jeht\Interfaces\Support\Responsable|int  $code
	 * @param  string  $message
	 * @param  array  $headers
	 * @return void
	 *
	 * @throws \Jeht\Http\Exceptions\HttpException
