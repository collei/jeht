...
/**
 * Adapted from Laravel's Illuminate\Routing\SortedMiddleware
 * @link https://laravel.com/api/9.x/Illuminate/Routing/SortedMiddleware.html
 * @link https://github.com/laravel/framework/blob/9.x/src/Illuminate/Routing/SortedMiddleware.php
 * @link https://github.com/laravel/framework/blob/9.x/LICENSE.md
 *
 */
class SortedMiddleware extends Collection
{
	 ...
	 * @param  \Jeht\Support\Collection|array  $middlewares
	 * @return void
	 */
