...
/**
 * Adapted from Laravel's Illuminate\Log\LogManager
 * @link https://laravel.com/api/8.x/Illuminate/Log/LogManager.html
 * @link https://github.com/laravel/framework/blob/8.x/src/Illuminate/Log/LogManager.php
 *
 */
class LogManager implements LoggerInterface
{
	...
	protected function get($name, ?array $config = null)
	{
		try {
			...
			return $this->tapValue($this->createEmergencyLogger(), function ($logger) use ($e) {
	 ...
	 *
	 * @param  string  $name
	 * @param  \Jeht\Log\Logger  $logger
	 * @return \Jeht\Log\Logger
	 */
	...
	{
		return $this->tapValue(new LineFormatter(null, $this->dateFormat, true, true), function ($formatter) {
